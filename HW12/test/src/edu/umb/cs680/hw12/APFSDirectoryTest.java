...
class APFSDirectoryTest {
	...
	public void getSubDirectoriesReverse() {
		...
		for (APFSDirectory d : root.getSubDirectories(new APFSReverseAlphabeticComparator())) {
			preActual.add(d.getName());
		}
	...
	public void getFilesReverse() {
		...
		for (APFSFile f : applications.getFiles(new APFSReverseAlphabeticComparator())) {
			preActual.add(f.getName());
		}
	...
	public void getChildrenReverse() {
		...
		for (APFSElement ele : home.getChildren(new APFSReverseAlphabeticComparator())) {
			preActual.add(ele.getName());
		}
	...
	public void getChildrenDirectoryFirst() {
		...
		for (APFSElement ele : home.getChildren(new APFSDirectoryFirstComparator())) {
			preActual.add(ele.getName());
		}
